// Class which tests validity of our LinkedList methods
...
// construct empty IntegerLinkedList
		...
		System.out.println("Number of items in the list: " + numbers.getNumberOfItems()
		+ "\n" + numbers.toString());
		...
		System.out.println("Number of items in list: " + numbers.getNumberOfItems()
		+ "\n" + numbers.toString());
